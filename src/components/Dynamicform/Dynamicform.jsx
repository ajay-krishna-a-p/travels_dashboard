    ...
    <div>
      ...
      {type === 'dropdown' && (
        <div >
          ...
          <Button onClick={() => onChange('addDropdownOption', '')} className='mt-2'>Add Option</Button>
        </div>
      )}
      {type === 'radio_button' && (
        <div>
          ...
          <Button onClick={() => onChange('addOption', '')} className='mt-2'>Add Option</Button>
        </div>
      )}
    ...
    <>
      ...
      <Dropdown.Toggle as={Button} variant="secondary" size="xs" onClick={() => handleAddField()} className="me-2">
        <FontAwesomeIcon icon={faPlus} className="me-2" />Add Field
                ...
                {/* <Col className="text-right " md='12' ><Button onClick={handleAddField} >
              ...
              <div className='mt-4'>
                <Row style={{ paddingRight: '22px' }}>
                  <Col className='text-right'><Button onClick={() => onClick({ name: name, image: file })}><span style={{ paddingLeft: '20px', paddingRight: '20px' }}>Submit</span> </Button></Col>
                </Row>
              </div>
            </Form>
          </div>
