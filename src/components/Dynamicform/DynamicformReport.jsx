...
const nextButton = (status)=>{
  ...
  setbuttonCount(buttonCount + 1);
      ...
      const next = query(
    collection(db,`products`),orderBy("createdAt","desc"),where("response","==","rejected"),
    ...
    fetchproducts(next,"rejected");
        ...
        setbuttonCount(buttonCount + 1);
      const next = query(
        collection(db,`products`),orderBy("createdAt","desc"),where("response","==","active"),
    ...
    fetchproducts(next,"active");
        ...
        setbuttonCount(buttonCount + 1);
      const next = query(
     collection(db,`products`),orderBy("createdAt","desc"),where("response","==","pending"),
 ...
 <div className="form-group">
    ...
    <Box sx={{ width: '100%' }}>
      ...
      <TabPanel value={value} index={1}>
        ...
        handleExport={()=>handleExport("active")}
        selectedOrientation={selectedOrientation}
        setSelectedOrientation={handleOrientationChangeparent}
        handleOrientationChange={handleOrientationChangeparent}
        number1={number1}
      ...
      <Downloadoption
        ...
        handleExport={()=>handleExport("rejected")}
        selectedOrientation={selectedOrientation}
        setSelectedOrientation={handleOrientationChangeparent}
        handleOrientationChange={handleOrientationChangeparent}
        number1={number1}
