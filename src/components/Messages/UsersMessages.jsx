            ...
            <Row >
              <Col xs={8}  lg={3} xl={4} >
                <InputGroup className="mb-3">
                  ...
                  <Form.Control
          type="text"
          placeholder="Search by category/itemname"
              ...
              <Card.Body className="pt-0">
                <Table style={{height: '100px', overflow: 'auto'}} hover className="user-table align-items-center">
                  <thead>
                    ...
                    <th className="border-bottom" >Messages</th>
                  ...
                  <tbody>
                      ...
                      <tr >
                        ...
                        <td>10-06-2024</td>
                        <td>item_1</td>
                        <td><Chip label="23"  style={{backgroundColor:'red',color:'white'}}></Chip></td>
                       
                        <td>
                          <Button variant="success" onClick={()=>navigate('/messages')} style={{color:'white'}}>View</Button>
                        </td>
                      </tr>
                      <tr >
                        <td>2</td>
                        ...
                        <td>10-06-2024</td>
                        <td>item_2</td>
                        <td><Chip label="323"  style={{backgroundColor:'red',color:'white'}}></Chip></td>
