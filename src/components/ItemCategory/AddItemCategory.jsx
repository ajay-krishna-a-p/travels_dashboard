    ...
    <>
      ...
      <Dropdown.Toggle as={Button} variant="secondary" size="xs" onClick={() => handleAddField()} className="me-2">
        <FontAwesomeIcon icon={faPlus} className="me-2" />Add Field
                ...
                <Col className="mb-3 " md='12' style={{textAlign:'right', paddingRight: '22px'}} ><Button onClick={handleAddField} >
              ...
              <div className='mt-4'>
                <Row style={{ paddingRight: '22px' }}>
                  <Col className='text-right' style={{textAlign:'right'}}><Button onClick={() => onClick({ name: name, image: file })}><span style={{ paddingLeft: '20px', paddingRight: '20px' }}>Submit</span> </Button></Col>
                </Row>
              </div>
            </Form>
          </div>
