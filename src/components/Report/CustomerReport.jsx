        ...
        <>
          ...
          <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <div className="d-block mb-4 mb-md-0">
              ...
              <h4>Cutomer Engagement Report</h4>
            </div>
              ...
              <Card.Body className="pt-0">
                <Table style={{height: '100px', overflow: 'auto'}} hover className="user-table align-items-center">
                  <thead>
                    ...
                    <th className="border-bottom" style={{textWrap:'nowrap'}}>Email</th>
                    <th className="border-bottom" style={{textWrap:'nowrap'}}>Engaged Product</th>
                   
                    <th className="border-bottom" style={{textWrap:'nowrap'}}>Sold Product</th>
