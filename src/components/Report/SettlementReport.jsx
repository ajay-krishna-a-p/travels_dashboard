              ...
              <Card.Body className="pt-0">
                <Table style={{height: '100px', overflow: 'auto'}} hover className="user-table align-items-center">
                  <thead>
                    ...
                    <th className="border-bottom" style={{textWrap:'nowrap'}}>Customer Name</th>
                    <th className="border-bottom"  style={{textWrap:'nowrap'}}>Item Name</th>
                    <th className="border-bottom"  style={{textWrap:'nowrap'}}>Category</th>
                    <th className="border-bottom" style={{textWrap:'nowrap'}}>Requirement</th>
                    <th className="border-bottom" style={{textWrap:'nowrap'}}>Sold</th>
                    <th className="border-bottom" style={{textWrap:'nowrap'}}>Total Requirement</th>
                    <th className="border-bottom" style={{textWrap:'nowrap'}}>Total Sold</th>
                  ...
                  <tbody>
                      ...
                      <tr >
                        ...
                        <td>Ajay</td>
                        <td>Villa</td>
                        <td style={{textWrap:'nowrap'}}>3BHK House</td>
                        <td>23</td>
                       
                        <td style={{textWrap:'nowrap'}}>23</td>

                        <td> <Chip label="₹ 234534" color="primary" variant="outlined" /></td>
                          <td style={{  whiteSpace: 'nowrap' }}><Chip label="₹ 237454" color="success" variant="outlined" /></td>
                        <td>
                      ...
                      <tr >
                        ...
                        <td>Athul</td>
                        <td>Apartment</td>
                        <td style={{textWrap:'nowrap'}}>3BHK Flat</td>
                        <td>42</td>
                       
                        <td style={{textWrap:'nowrap'}}>43</td>

                        <td> <Chip label="₹ 6543223" color="primary" variant="outlined" />
                       </td>
                          <td style={{  whiteSpace: 'nowrap' }}> <Chip label="₹ 1234543" color="success" variant="outlined" /></td>
                        <td>
                          <Button variant="success" onClick={()=>handleNavigate(doc)} style={{color:'white'}}>View</Button>
                        </td>
                      </tr>
