...
export default function VehicleHistory() {
  ...
  const handleAddNavigate = () => {
    navigate("/AddVehicleHistory")
  }
  const handleViewNavigate = () => {
    navigate("/ViewVehicleHistory")
  }
  const handleEditNavigate = () => {
    navigate("/EditVehicleHistory")
  } 
  return (
    <div>
      ...
      <Table sx={{ minWidth: 700 }} aria-label="customized table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="left">KM</StyledTableCell>
        ...
        <TableBody>
            ...
            <StyledTableRow >
              ...
              <StyledTableCell align="left">23</StyledTableCell>
