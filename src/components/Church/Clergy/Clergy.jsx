...
export default function Clergy() {
    ...
    return (
        <div>
            <Button className='mb-2' onClick={() => handleNavigate()}>Add Clergy</Button>
            <Card>
                <CardBody>
                        ...
                        >
                            ...
                            <tbody>
                                ...
                                <tr >
                                    ...
                                    <td>Youth development chairman</td>
                                    <td>priest</td>
                                    <td><Button style={{ borderRadius: '50%' }}><FontAwesomeIcon icon={faPencil} style={{ fontSize: '12px' }} /></Button></td>
                                    <td> <Tooltip title="Delete">
                                        <FontAwesomeIcon icon={faTrash} />
                                    </Tooltip></td>
                                </tr>
